...
笔者在 2024 年 8 月份部署了本地化的 LobeChat Database 服务，但是鉴权服务还不支持本地部署，**由于大陆的网络原因**，使用的 auth0 鉴权服务经常失败。今天 (2024.9.22) 发现官方仓库支持完全本地部署的 LobeChat Database 版本了，于是开始重新部署，期间也踩了很多坑。这里记录下来仅供参考。

完全本地化部署的 LobeChat Database 已经达到**个人生产可用的级别**，可以在个人笔记本、家庭服务器等环境中部署一套使用。
